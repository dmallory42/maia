...
class NewCommand extends Command
{
    ...
    private function writeFiles(string $target, string $projectName): void
    {
        $files = [
            ...
            'CLAUDE.md' => $this->claudeManifest($projectName),
            'AGENTS.md' => $this->agentsManifest($projectName),
...
PHP;
    ...
    private function claudeManifest(string $projectName): string
    {
        return "# {$projectName}\n\nMaia project scaffold.\n";
    }

    private function agentsManifest(string $projectName): string
    {
        return "# AGENTS for {$projectName}\n\nGenerated by maia new.\n";
    }
